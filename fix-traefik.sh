...
print_info "Baixando Traefik v3.2 (compatível com Docker API 1.44+)..."
...
print_success "Imagem Traefik v3.2 baixada com sucesso!"
...
echo ""
print_success "✅ Traefik corrigido para v3.2"
